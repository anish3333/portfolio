      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex gap-4">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-zinc-100 text-xl font-semibold">Pragadeswaran</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-zinc-100 hover:bg-zinc-700">
